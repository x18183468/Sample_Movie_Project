...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { firstname: @director.firstname, lastname: @director.lastname, movie_id: @director.movie_id } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { firstname: @director.firstname, lastname: @director.lastname, movie_id: @director.movie_id } }
